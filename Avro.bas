Attribute VB_Name = "Avro"

Option Explicit
'Main Function
Function SpellNumberAvro(ByVal MyNumber)
    Dim Avro, Sent, Temp
    ...
    If DecimalPlace > 0 Then
        Sent = GetTens(Left(Mid(MyNumber, DecimalPlace + 1) & _
                  "00", 2))
    ...
    Do While MyNumber <> ""
        ...
        If Temp <> "" Then Avro = Temp & Place(Count) & Avro
